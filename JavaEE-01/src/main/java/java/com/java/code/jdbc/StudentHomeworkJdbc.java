...
import java.com.java.code.model.Homework;
import java.com.java.code.model.Student;
import java.com.java.code.model.Student_Homework;
...
public class StudentHomeworkJdbc {
    ...
    public static void addStudentHomework(Student_Homework sh)
    {
        ...
        try(   Connection connection = DataBasePool.getHikariDataSource()){
