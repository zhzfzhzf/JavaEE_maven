<%@ page import="java.com.java.code.model.Homework" %>
<%@ page import="java.com.java.code.jdbc.StudentHomeworkJdbc" %>
...
<body>
<a href="../../../JavaEE-SecondAssignment/web/index.jsp">返回上一页</a>
<br/>
